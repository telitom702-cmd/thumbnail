...
async def video_handler(bot, update):
    ...
    try:
        ...
        # --- ক্যাপশন ও ফাইল নাম ঠিক করার কোড ---
        # ইউজারের অরিজিনাল ক্যাপশন চেক করা হচ্ছে, না থাকলে ডিফল্ট মেসেজ দেখাবে
        caption = update.caption if update.caption else "**এখানে আপনার ভিডিও 🎬**"
        
        # টেলিগ্রামে ক্যাপশনের সর্বোচ্চ লিমিট ১০২৪ ক্যারেক্টার। এর বেশি হলে কেটে যাওয়া বা এরর আসা ঠেকাতে লিমিট রাখা হলো।
        if len(caption) > 1024:
            caption = caption[:1024]

        # ভিডিওর অরিজিনাল ফাইলের নাম বের করা হচ্ছে, না থাকলে ডিফল্ট নাম দেওয়া হবে
        file_name = update.video.file_name if update.video.file_name else f"{update.id}.mp4"
        # ---------------------------------
        ...
        await bot.send_video(
            ...
            caption=caption,          # অরিজিনাল ক্যাপশন যোগ করা হয়েছে
            file_name=file_name,      # অরিজিনাল ফাইল নাম যোগ করা হয়েছে
            progress=progress_for_pyrogram,
            progress_args=(
                "**আপলোড হচ্ছে... 🚀**",
                m,
